...
export function websiteSchema(site: URL) {
  return {
    ...
    description: 'Proof-of-work portfolio covering production AI, agent systems, computer vision, multimodal AI, clinical AI, quantitative research, and technical leadership.',
    inLanguage: 'en',
