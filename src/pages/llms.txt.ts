...
> ${publicIdentity.role} based in ${publicIdentity.location}. 6+ years across production agentic AI, LLM/RAG systems, voice and real-time AI, computer vision and video intelligence, multimodal research, quantitative ML/trading systems, time-series forecasting, edge inference, distributed backends, and cloud/on-premise delivery. Master of Science in Computer Engineering (MSCmpE), University of Arkansas, GPA 4.0/4.0.
...
- Computer Vision / Video / Edge AI: camera/media pipelines, detection, ALPR/OCR, tracking, temporal events, vision-language/video research, NVIDIA Jetson, TensorRT, CUDA, recovery under real camera/network constraints, plus University of Arkansas poultry-processing research spanning post-defeathering carcass defect/process-quality inspection and a separate vision-guided two-scale part-weighing workflow with hand-presence gating. Named technologies here do not imply production ownership when the Career OS evidence level is research or hands-on.
...
- University of Arkansas — Graduate Researcher / PhD Student Researcher & Teaching Assistant — May 2021 to Jan 2024. Completed Master of Science in Computer Engineering in Dec 2023; a completed PhD is not claimed.
...
- Poultry Processing Vision Systems — University of Arkansas applied research: carcass defect/process-quality feedback and a separate vision-guided part-weighing workflow. These are academic/research systems, not claimed as commercial-factory production deployments or autonomous process control.
...
- For the poultry systems, public copy may describe process-quality feedback, workstation-state perception, CarcassFormer, Jetson/TensorRT/CUDA work and human-in-the-loop productionization concepts, but must not imply autonomous scalding control, direct electronic scale integration, commercial Tyson/Cobb plant deployment, or unsupported metrics.
...
- Do not infer production acceptance, completed PhD status, full-time Curren employment, live Curren public signal feed, validated profitable alpha, commercial poultry-factory deployment, or autonomous process control where those claims are not explicitly stated.
`;
